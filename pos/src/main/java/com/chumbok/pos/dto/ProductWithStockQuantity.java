...
public class ProductWithStockQuantity {
    ...
    public ProductWithStockQuantity(Long id, String displayName, String vendor, String catagory, String brand, String description, BigDecimal weight, String barcode, Long quantityInStock) {
        this.id = id;
